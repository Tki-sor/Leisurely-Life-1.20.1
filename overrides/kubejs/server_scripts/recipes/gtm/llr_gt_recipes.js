ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.void_gas_collection_chamber("gtceu:void_gas_collection_chamber" + getIncNum())
        .EUt(480)
        .notConsumable("minecraft:dirt")
        .outputFluids('gtceu:air 200000')
        .duration(10 * 20)
    event.recipes.gtceu.void_gas_collection_chamber("gtceu:void_gas_collection_chamber" + getIncNum())
        .EUt(1920)
        .notConsumable("minecraft:dirt")
        .notConsumable('gtceu:vacuum_freezer')
        .outputFluids('gtceu:liquid_air 200000')
        .duration(10 * 20)
    event.recipes.gtceu.void_gas_collection_chamber("gtceu:void_gas_collection_chamber" + getIncNum())
        .EUt(480)
        .notConsumable('minecraft:netherrack')
        .outputFluids('gtceu:nether_air 175000')
        .duration(10 * 20)
    event.recipes.gtceu.void_gas_collection_chamber("gtceu:void_gas_collection_chamber" + getIncNum())
        .EUt(1920)
        .notConsumable('minecraft:netherrack')
        .notConsumable('gtceu:vacuum_freezer')
        .outputFluids('gtceu:liquid_nether_air 175000')
        .duration(10 * 20)
    event.recipes.gtceu.void_gas_collection_chamber("gtceu:void_gas_collection_chamber" + getIncNum())
        .EUt(480)
        .notConsumable('minecraft:end_stone')
        .outputFluids('gtceu:ender_air 150000')
        .duration(10 * 20)
    event.recipes.gtceu.void_gas_collection_chamber("gtceu:void_gas_collection_chamber" + getIncNum())
        .EUt(1920)
        .notConsumable('minecraft:end_stone')
        .notConsumable('gtceu:vacuum_freezer')
        .outputFluids('gtceu:liquid_ender_air 150000')
        .duration(10 * 20)
    ...
    // 虚空钻井
    event.recipes.gtceu.void_oil_drill("void_oil_drill" + getIncNum())
        .EUt(120)
        .duration(5 * 20)
        .inputFluids('gtceu:drilling_fluid 100')
        .outputFluids('gtceu:oil 20', 'gtceu:oil_heavy 15', 'gtceu:oil_medium 20', 'gtceu:oil_light 25')
